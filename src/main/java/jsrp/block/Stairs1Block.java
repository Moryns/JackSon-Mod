...
public class Stairs1Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_1")
	public static final Block block = null;

	public Stairs1Block(JsrpModElements instance) {
		super(instance, 22);
	}
