...
public class Stairs9Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_9")
	public static final Block block = null;

	public Stairs9Block(JsrpModElements instance) {
		super(instance, 30);
	}
