...
public class Stairs5Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_5")
	public static final Block block = null;

	public Stairs5Block(JsrpModElements instance) {
		super(instance, 26);
	}
