...
public class Stairs6Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_6")
	public static final Block block = null;

	public Stairs6Block(JsrpModElements instance) {
		super(instance, 27);
	}
