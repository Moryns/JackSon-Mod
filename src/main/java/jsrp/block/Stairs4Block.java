...
public class Stairs4Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_4")
	public static final Block block = null;

	public Stairs4Block(JsrpModElements instance) {
		super(instance, 25);
	}
