...
public class Stairs3Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_3")
	public static final Block block = null;

	public Stairs3Block(JsrpModElements instance) {
		super(instance, 24);
	}
