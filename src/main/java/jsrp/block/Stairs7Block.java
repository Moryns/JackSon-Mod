...
public class Stairs7Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_7")
	public static final Block block = null;

	public Stairs7Block(JsrpModElements instance) {
		super(instance, 28);
	}
