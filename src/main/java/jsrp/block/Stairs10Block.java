...
public class Stairs10Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_10")
	public static final Block block = null;

	public Stairs10Block(JsrpModElements instance) {
		super(instance, 31);
	}
