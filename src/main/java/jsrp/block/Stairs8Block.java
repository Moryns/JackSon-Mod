...
public class Stairs8Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_8")
	public static final Block block = null;

	public Stairs8Block(JsrpModElements instance) {
		super(instance, 29);
	}
