...
public class Stairs11Block extends JsrpModElements.ModElement {
	@ObjectHolder("jsrp:stairs_11")
	public static final Block block = null;

	public Stairs11Block(JsrpModElements instance) {
		super(instance, 32);
	}
